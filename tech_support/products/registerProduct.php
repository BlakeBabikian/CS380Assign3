...
if (! empty($email)) {
    ...
    if (! empty($line)) {
        ...
        echo "<form action='registerProduct.php' method='post' id='aligned'>";
        echo "<label for'' id='aligned'>Product:</label>";
        ...
        echo "</select><br><br>";
        echo "<input type='submit' name='Register' style='margin-left: 145px;'><br><br>";
        mysqli_close($con);
    }
    else{
